...
void main() {
  group('Screen Reader Accessibility', () {
    testWidgets('should provide semantic labels for all items', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should announce expansion state changes', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        TestUtils.createTestApp(
    ...
    testWidgets('should provide context for drag operations', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        TestUtils.createTestApp(
    ...
    testWidgets('should announce selection changes', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        TestUtils.createTestApp(
          ...
          onSelectionChanged:
              (Set<Uri> selection) {}, // Verify selection announcements
        ),
      );
    ...
    testWidgets('should handle live regions for updates', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should provide loading state announcements', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
