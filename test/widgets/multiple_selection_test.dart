...
void main() {
  group('Multiple Selection Tests', () {
    testWidgets(
      'Shift+click should enable multiple selection when selectionMode is multiple',
      (WidgetTester tester) async {
        ...
        expect(
          ...
          3,
          reason: 'Shift+click should enable range selection',
        );
        expect(selectedPaths.contains(Uri.parse('file://file1.txt')), true);
    ...
    testWidgets(
      'Multiple selection mode should allow selecting multiple items individually',
      (WidgetTester tester) async {
        Set<Uri> selectedPaths = {};
        ...
        expect(
          selectedPaths.length,
          2,
          reason: 'Ctrl+click should add to selection in multiple mode',
        );
        expect(selectedPaths.contains(Uri.parse('file://file1.txt')), true);
        expect(selectedPaths.contains(Uri.parse('file://file2.txt')), true);
      },
