...
void main() {
  group('Animation Tests', () {
    testWidgets('should animate expansion when animateExpansion is true', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should not animate expansion when animateExpansion is false', (
      WidgetTester tester,
    ) async {
      final List<Uri> paths = TestUtils.sampleFilePaths;
    ...
    testWidgets('should animate collapse when animateExpansion is true', (
      WidgetTester tester,
    ) async {
      final List<Uri> paths = TestUtils.sampleFilePaths;
