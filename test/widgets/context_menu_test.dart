  ...
  group('Context Menu Tests', () {
    testWidgets('Right-click should trigger onContextMenu callback', (
      ...
      expect(
        contextMenuCalled,
        true,
        reason: 'onContextMenu should be called on right-click',
      );
    ...
    testWidgets(
      'Context menu should work without interfering with normal tap',
      (WidgetTester tester) async {
        ...
        expect(
          normalTapCalled,
          true,
          reason: 'Normal tap should trigger onItemTap',
        );
        expect(
          contextMenuCalled,
          false,
          reason: 'Normal tap should not trigger context menu',
        );
        ...
        expect(
          contextMenuCalled,
          true,
          reason: 'Right-click should trigger context menu',
        );
        expect(
          normalTapCalled,
          false,
          reason: 'Right-click should not trigger normal tap',
        );
      },
    );

    testWidgets(
      'Context menu should use onSecondaryTap instead of onSecondaryTapDown for web compatibility',
      (WidgetTester tester) async {
        ...
        expect(
          contextMenuCalled,
          true,
          reason: 'Context menu should be triggered by secondary tap',
        );
      },
    );
  });
