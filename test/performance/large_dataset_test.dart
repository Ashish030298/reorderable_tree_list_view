...
void main() {
  group('Large Dataset Performance', () {
    testWidgets('should render 1000+ items efficiently', (
      WidgetTester tester,
    ) async {
      ...
      await tester.pumpWidget(TestUtils.createTestApp(paths: largePaths));
    ...
    testWidgets('should scroll smoothly with large dataset', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should handle expansion of large folders', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should efficiently update when data changes', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should not rebuild unnecessary widgets', (
      WidgetTester tester,
    ) async {
      int buildCount = 0;
    ...
    testWidgets('should handle memory efficiently', (
      ...
      await tester.pumpWidget(TestUtils.createTestApp(paths: paths));

      // Navigate away to dispose
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(body: Center(child: Text('Disposed'))),
        ),
      );
    ...
    testWidgets('should use viewport optimization', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should handle deep nesting efficiently', (
      WidgetTester tester,
    ) async {
      final deepPaths = <Uri>[];
