...
void main() {
  group('Keyboard Navigation Integration', () {
    testWidgets('complete keyboard navigation flow', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        TestUtils.createTestApp(
          ...
          onSelectionChanged:
              (Set<Uri> selection) {}, // Verify selection with keyboard
    ...
    testWidgets('keyboard shortcuts with modifiers', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        TestUtils.createTestApp(
    ...
    testWidgets('keyboard navigation with filtering', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('keyboard interactions with drag and drop', (
      WidgetTester tester,
    ) async {
